...
title CoverMorph Studio v0.5.1 - EXE Build
cd /d "%~dp0"
...
".venv\Scripts\pyinstaller.exe" --noconfirm --clean --windowed --onedir --name "CoverMorphStudio_v0.5.1" --collect-all "customtkinter" --add-data "presets;presets" --add-data "hub_manifest.json;." --add-data "tools\README.txt;tools" "app.py"
if errorlevel 1 goto build_error

echo [3/3] Done.
echo SUCCESS: Check "dist\CoverMorphStudio_v0.5.1"

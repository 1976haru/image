...
def generate_scene_candidates(
    ...
    try:
        ...
        "approval_source": str(scene.structured_request.get("approval_source") or "advanced_card"),
        "textless_background": bool(scene.structured_request.get("textless_background", False)),
        "source_input_ids": list(scene.structured_request.get("source_input_ids") or []),
